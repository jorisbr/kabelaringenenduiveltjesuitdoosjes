...
install_n10s_plugin() {
  echo "Installing neosemantics 5.2.0.0"
  wget -P /var/lib/neo4j/plugins https://github.com/neo4j-labs/neosemantics/releases/download/5.2.0.0/neosemantics-5.2.0.0.jar
}
